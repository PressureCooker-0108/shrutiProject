...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    category: "Refresher",
    description: "Vibrant strawberry acai base combined with water, served over ice and topped with freeze-dried strawberry slices.",
    price: 395,
    calories: 90,
    image: "/images/menu-22.jpeg",
    bgColor: "from-[#FFF0F2] via-[#FFD3DC]/40 to-[#E05F7C]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#E05F7C] text-white",
    caffeine: "45 mg",
    sugar: "20g",
    fat: "0g",
    joke: "Because water is too boring and you need a sweet pink accessory to carry around during lectures.",
    preset: {
      base: "Strawberry Acai",
      milk: "None",
      sweetener: "Classic Syrup",
  ...
  {
    id: "blue-coconut-energy",
    name: "Blue Coconut Energy Refresher",
    category: "Refresher",
    description: "An energizing blend of blue raspberry, coconut water, and green coffee extract, poured over ice with a lime slice.",
    price: 435,
    calories: 120,
    image: "/images/menu-23.jpeg",
    bgColor: "from-[#E0F7FA] via-[#B2EBF2]/40 to-[#00ACC1]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#00ACC1] text-white",
    caffeine: "85 mg",
    sugar: "24g",
    fat: "0.5g",
    joke: "Neon blue liquid that looks like windshield wiper fluid but tastes like tropical energy and poor life decisions.",
    preset: {
      base: "Blue Raspberry Energy",
      milk: "Coconut Water",
      sweetener: "None",
      topping: "None",
      ice: "Regular",
  ...
  },
  {
    ...
    category: "Tea & Matcha",
    description: "Spearmint, lemon verbena, and lemongrass green tea blended with peach juice and poured over ice.",
    price: 355,
    calories: 60,
    image: "/images/menu-24.jpeg",
    bgColor: "from-[#FFF8E1] via-[#FFE082]/40 to-[#FFB300]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#FFB300] text-white",
    caffeine: "25 mg",
    sugar: "12g",
    fat: "0g",
    joke: "The peach flavor hides the grass-like taste of green tea, so you can pretend you like wellness.",
    preset: {
      base: "Green Tea",
      milk: "None",
      sweetener: "Peach Juice",
      topping: "None",
      ice: "Regular",
      size: "Grande"
    }
  },
  {
    ...
    category: "Tea & Matcha",
    description: "Black tea infused with cinnamon, clove, and other warming spices, combined with milk and ice.",
    price: 395,
    calories: 240,
    image: "/images/menu-25.jpeg",
    bgColor: "from-[#F7F2EC] via-[#E6D7C3]/40 to-[#A0805B]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#A0805B] text-white",
    caffeine: "95 mg",
    sugar: "42g",
    fat: "6g",
    joke: "Cold spiced milk that makes you smell like a cozy winter candle in the middle of a hot summer afternoon.",
    preset: {
      base: "Chai Tea",
      milk: "Oat Milk",
      sweetener: "Honey",
  ...
  },
  {
    ...
    name: "Chai Latte",
    category: "Tea & Matcha",
    description: "Steamed milk combined with black tea infused with cardamom, cinnamon, and cloves, topped with foam.",
    price: 380,
    calories: 240,
    image: "/images/menu-26.jpeg",
    bgColor: "from-[#F5EFE6] via-[#DFD3C3]/40 to-[#8D7B68]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#8D7B68] text-white",
    caffeine: "95 mg",
    sugar: "42g",
    fat: "6g",
    joke: "For when you want tea but also want it to be 90% warm spiced milk and foam.",
    preset: {
      base: "Chai Tea",
      milk: "Whole Milk",
      sweetener: "None",
  ...
  },
  {
    ...
    category: "Tea & Matcha",
    description: "A soothing blend of green tea, peach herbal tea, steamed lemonade, and a touch of honey.",
    price: 390,
    calories: 130,
    image: "/images/menu-27.jpeg",
    bgColor: "from-[#FFFDE7] via-[#FFF59D]/40 to-[#FBC02D]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#FBC02D] text-[var(--cold-brew)]",
    caffeine: "16 mg",
    sugar: "30g",
    fat: "0g",
    joke: "Also known as the 'Medicine Ball', ordered by everyone who woke up with a slight tickle in their throat.",
    preset: {
      base: "Green & Peach Tea",
      milk: "None",
      sweetener: "Honey",
      topping: "Lemon Slice",
      ice: "None",
  ...
  },
  {
    ...
    name: "Cappuccino",
    category: "Coffee",
    description: "Dark, rich espresso lying under a smooth, thick layer of aerated steamed milk foam.",
    price: 340,
    calories: 140,
    image: "/images/menu-28.jpeg",
    bgColor: "from-[#F5ECE5] via-[#D8C3A5]/45 to-[#8E7F7F]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#8E7F7F] text-white",
    caffeine: "150 mg",
    sugar: "10g",
    fat: "5g",
    joke: "Mostly warm air and foam, but it makes you look very European and intellectual while checking emails.",
    preset: {
      base: "Espresso",
      milk: "Whole Milk",
      sweetener: "None",
  ...
  },
  {
    ...
    category: "Coffee",
    description: "Our slow-steeped cold brew topped with a delicate float of house-made vanilla sweet cream.",
    price: 395,
    calories: 110,
    image: "/images/menu-29.jpeg",
    bgColor: "from-[#ECE5DD] via-[#D2C4B9]/45 to-[#4E3629]/20",
    textColor: "text-[var(--cold-brew)]",
    accentColor: "bg-[#4E3629] text-white",
    caffeine: "185 mg",
    sugar: "14g",
    fat: "5g",
    joke: "Cold brew coffee topped with vanilla cream so you get the intense caffeine kick without the intense bitter reality.",
    preset: {
      base: "Cold Brew",
      milk: "Vanilla Sweet Cream",
      sweetener: "Vanilla Syrup",
      topping: "None",
      ice: "Regular",
      size: "Grande"
